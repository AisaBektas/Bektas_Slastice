    ...
    <div class="row d-flex justify-content-center">
		...
		<form action="preglednarudzbi.php" method="POST" class="text-center" >
            ...
            <div class="col-12 col-md-6 text-center">
               ...
               <a href="printnarudzbe.php?narudzba=<?php echo $narudzba['id_narudzbe']; ?>" target="_blank"><button class="btn text-uppercase font-weight-bold" id="print">Ispis</button></a>
           </div>
            </div>
            </div>
