...
<input type="submit" name="ulaz" class="btn rounded-pill px-5 font-weight-bold dodaj hover" value="Narudžba" /> 
</form> 
</div>
</div>
</div>
            ...
            <?php 
                ...
                <div  class="carousel-item col-12 col-sm-6 col-md-4 col-lg-3 col-xl-3 <?php echo $actives; ?>">
					...
					<div class="card textcard bojatekstakartice font-italic color pt-4">
                    	...
                    	<img id="velicina_slika_user" class="img-fluid mx-auto d-block rounded-pill shadow p-1" src="<?php echo $row['picture']?>" alt="cokotorta">
					...
					<div class="card-footer">
				  		<p class="text-right font-weight-bold"><?= $row['price']?>&nbsp;KM</p> <!-- shorthand for <?php //echo $row['price']?>-->
                    </div>
