...
<body class="pozadina">
    ...
    <a id="hover" class="navbar-brand font-weight-bold px-3 rounded-pill d-none d-md-block" href="index.php">&nbsp;Bektaš<br>Slastice</a>
      ...
      <a class="text-decoration-none" href="index.php" data-toggle="popover" data-placement="left" data-trigger="hover" data-content="Početna"><h1 class="font-weight-bold" id="navbarpregleda">Torte</h1>  </a>  
</div>
</div>
      <a id="hover" class="navbar-brand font-weight-bold px-3 rounded-pill d-none d-md-block" href="index.php">&nbsp;Bektaš<br>Slastice</a>
