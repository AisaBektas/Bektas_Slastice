...
<div class="jumbotron mt-5 ml-3 mr-3 rounded-0">
    ...
    <p class="lead text-justify">Bektaš Slastice je slastičarna smještena u vezirskom gradu Travniku. Počela je sa radom davne 1970. godine. Nakon skoro pet decenija tradicije i iskustva "Bektaš Slastice" je i dalje omiljeno mjesto za okupljanje svih generacija, onih koji žele da uživaju u otmjenom i prijatnom ambijentu slatkih mirisa i okusa.
	<br>Široki asortiman toplih, hladnih, čokoladnih napitaka, prirodnih i osvježavajućih sokova, frapea, kupova i specijaliteta od sladoleda, te mnogobrojnih vrsta torti, kolača, slanih i slatkih peciva je dovoljan da ugodi svačijem ukusu. Sve poslastice koje se nalaze na našem meniju su ručno i sa ljubavlju rađene u „Bektaš Slastici“ po tradicionalnim receptima, kao i po receptima koji su plod inovacije vlasnika i možete ih pronaći samo u našoj slastičarnoj. Materijali od kojih pravimo sve proizvode su pažljivo i pomno birani jer vaše povjerenje je ono što nam je najbitnije.<br>Osnivač i vlasnik "Bektaš Slastice", čitav život je posvetio poslastičarstvu. Slastičarsku i poslovnu karijeru počeo je kao učenik, a kasnije i kao vodeći majstor u nekad čuvenoj slastičarni «Oloman» u Sarajevu. Nakon godinu mukotrpnog rada i truda odlučio je da otvori svoju slastičarnu i tu čarolija „Bektaš Slastice“ počinje.</p></div>
    ...
    <div id="menu" class="container-fluid mt-5 pt-5">
			<div class="row text-center pb-3">
				...
				<div class="col-md-4 col-sm-6 col-12 pb-4"><a href="kolac.php" target="_blank" class="text-decoration-none bojazatekstmenu"><img src="images/kolacizlog_300x200.jpg" class="rounded-pill img-fluid shadow" alt="kolacimenu">
						<h1 class="fontuser">Kolači</h1></a>
				</div>
				<div class="col-md-4 col-sm-6 col-12 pb-4"><a href="torte.php" target="_blank" class="text-decoration-none bojazatekstmenu"><img src="images/tortaizlog_300x200.jpg" class="rounded-pill img-fluid shadow" alt="tortemenu">
